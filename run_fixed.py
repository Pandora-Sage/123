...
BEST_PARAMS = {
    'mosi': {
        ...
        'multimodal_layers': 4, 'embed_dim': 32, 'prompt_len': 4,
        'miss_prob': 0.6095, 'lambda_gen': 0.3625, 'lambda_aux': 0.2598,
    },
    'mosei_senti': {
        'attn_dropout': 0.4353, 'embed_dropout': 0.3253, 'out_dropout': 0.3320,
        'l_kernel_size': 1, 'a_kernel_size': 2, 'v_kernel_size': 1,
        'multimodal_layers': 2, 'embed_dim': 32, 'prompt_len': 4,
        'miss_prob': 0.3975, 'lambda_gen': 0.4535, 'lambda_aux': 0.4273,
    },
    'meld_senti': {
        # Avg3-best: Full=67.36, L=67.16, A=51.69, Avg3=62.07
        'attn_dropout': 0.2750, 'embed_dropout': 0.4195, 'out_dropout': 0.3720,
        'l_kernel_size': 1, 'a_kernel_size': 2,
        'multimodal_layers': 3, 'embed_dim': 64, 'prompt_len': 8,
        'miss_prob': 0.4517, 'lambda_gen': 0.4966, 'lambda_aux': 0.4239,
    },
    'meld_emo': {
        # Avg3-best: Full=60.08, L=59.85, A=49.31, Avg3=56.41
        'attn_dropout': 0.1382, 'embed_dropout': 0.4775, 'out_dropout': 0.2203,
        'l_kernel_size': 1, 'a_kernel_size': 2,
        'multimodal_layers': 2, 'embed_dim': 64, 'prompt_len': 4,
        'miss_prob': 0.3942, 'lambda_gen': 0.3427, 'lambda_aux': 0.3812,
    },
}
